...
V1 = Geometry(
    ...
    alert_bottom=304,
    alert_icon=16,
    # Seven days, not five. The row pitch drops to 15px to buy them, which the
    # forecast can afford -- one line of a day, an icon and two numbers -- where
    # the events below could not, since each is two lines.
    week_eyebrow_y=48,
    week_top=66,
    week_step=15,
    week_days=7,
